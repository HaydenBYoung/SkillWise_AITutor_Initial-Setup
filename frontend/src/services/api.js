...
export const apiService = {
  ...
  challenges: {
    ...
    getByCategory: (category) => api.get(`/challenges/category/${category}`),
    getByGoalId: (goalId) => api.get(`/challenges/goal/${goalId}`),
  ...
  progress: {
    ...
    trackEvent: (eventData) => api.post('/progress/event', eventData),
  },
